...
function Essay({ essay }) {
  ...
  return (
    <div className="py-3 tw-flex tw-items-center tw-rounded-r-lg tw-border-r tw-border-t tw-border-gray-300 tw-pe-10 tw-ps-6 last:tw-border-b">
      <p className="tw-w-5/12">{essay.supplemental_essay_prompt}</p>

      <div className="tw-flex tw-w-7/12 tw-items-center tw-ps-2 *:tw-text-center">
